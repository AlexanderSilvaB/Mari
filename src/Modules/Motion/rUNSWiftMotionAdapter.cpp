...
void rUNSWiftMotionAdapter::Start()
{
...
{
    return touch->getSensors(kinematics);   
}

SensorValues rUNSWiftMotionAdapter::GetRawSensors()
{
    return nakedTouch->getSensors(kinematics);   
}