...
/**
 * Takes in a set of bounding boxes for the robots and tries to extend it up
 * to an estimated height for the robot. This should hopefully create a
 * possible robot from the feet to the head of the robot.
 */
class RobotHeightEstimator {

public:
	std::vector<PossibleRobot> complete(
	        VisionFrame &frame,
