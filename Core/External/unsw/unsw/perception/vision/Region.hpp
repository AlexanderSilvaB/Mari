...
public:
    ...
    protected:
        ...
        inline const int getAbovePos_() {
            return pos_-x_region_width_*x_density_*y_density_;
        }
    ...
    const
        ...
        /**
         * Get the blurred grey value at this pixel iteration point
         * @return blurred grey value
         */
        inline const int grey() { return getRegion_()->getPixelGrey_(getLinearPos_()); }

        /**
         * Get the edge vector at this pixel iteration point
         * @return edge vector
         */
        inline const
        #ifdef REGION_TEST
        ...
        Point&
        #endif
        edge() { return getRegion_()->getPixelEdge_(getLinearPos_()); }

        /**
         * Get the magnitude of the edge vector this pixel iteration point
         * @return magnitude of the edge vector
         */
        inline const int edgeMagnitude() { return getRegion_()->getPixelEdgeMagnitude_(getLinearPos_()); }
    };
                             ...
                             raw_to_fovea_density_(region.raw_to_fovea_density_)
    {
        init_(region, BBox(Point(box.a.x(), box.a.y()), Point(box.b.x(),
            ...
            regenerate_fovea_colour, regenerate_fovea_grey,
                                                         regenerate_fovea_edge);
    }
     ...
     */
    RegionI(const RegionI& region, int rel_density = 1,
                     int rel_density_multiplier = DENSITY_MAINTAIN,
                     const bool regenerate_fovea_colour = false,
                     const bool regenerate_fovea_grey = false,
                     const bool regenerate_fovea_edge = false)
     ...
     * @x region-relative x coordinate
     * @y region-relative x coordinate
     * @return blurred grey value of the pixel
     */
    inline const int getPixelGrey(int x, int y) const {
        return getPixelGrey_(getLinearPosFromXYFovea_(x, y));
    }

    /**
     * For a region-relative (x,y) pixel, return the
     *  edge vector of the pixel
     * @x region-relative x coordinate
     * @y region-relative x coordinate
     * @return edge vector of the pixel
     */
    inline const
    #ifdef REGION_TEST
    int
    ...
    Point&
    #endif
    getPixelEdge(int x, int y) const {
        return getPixelEdge_(getLinearPosFromXYFovea_(x, y));
    }

    /**
     * For a region-relative (x,y) pixel, return the
     *  magnitude of the edge vector of the pixel
     * @x region-relative x coordinate
     * @y region-relative x coordinate
     * @return magnitude of the edge vector of the pixel
     */
    inline const int getPixelEdgeMagnitude(int x, int y) const {
        return getPixelEdgeMagnitude_(getLinearPosFromXYFovea_(x, y));
    }
...
private:
    ...
    void init_(const RegionI& region, BBox box, int rel_density,
        int rel_density_multiplier, const bool regenerate_fovea_colour,
            const bool regenerate_fovea_grey, const bool regenerate_fovea_edge);
     ...
     * @return blurred grey value of the pixel
     */
    inline const int getPixelGrey_(int linear_pos) const {
        return this_fovea_->getFoveaGrey(linear_pos);
    }
    ...
    Point&
    #endif
    getPixelEdge_(int linear_pos) const {
        return this_fovea_->getFoveaEdge(linear_pos);
    }
     ...
     * @return magnitude of the edge vector of the pixel
     */
    inline const int getPixelEdgeMagnitude_(int linear_pos) const {
        return this_fovea_->getFoveaMagnitude(linear_pos);
    }
